...
const UsersController = {
  get router() {
    ...
    router.get('/companies', inject('getAllUsersWithCompany'), this.indexCompany);
  ...
  indexCompany(req, res, next) {
    const { getAllUsersWithCompany, userSerializer } = req;
    const { SUCCESS, ERROR } = getAllUsersWithCompany.outputs;
    ...
    getAllUsersWithCompany.execute();
  },
